        ...
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-green-50 py-8 px-4 sm:px-6">
            ...
            <div className="max-w-6xl mx-auto text-center mb-12">
                ...
                <p className="text-emerald-700 mt-4 text-lg sm:text-xl">
                    Jean Pierre Saint Fleur
                </p>
            </div>

            {/* Contenu principal */}
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden z-0">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-emerald-50 rounded-xl p-4 sm:p-6 max-h-96 overflow-y-auto">
                                    <p className="text-gray-700 leading-relaxed text-justify text-sm sm:text-base">
                                        Je suis Jean Pierre, l’aîné de notre bien-aimée Maman, Mme Fleurius Saint Fleur. 
                                        Ses marches infatigables vers Pont-Sondé et Verrettes, des paniers lourds sur la tête, m’ont permis de devenir qui je suis Aujourd’hui. 
                                        <br /><br />
                                        Son sacrifice a nourri mes rêves, et je porte sa force dans mon cœur. J’ai la chance d’avoir 15 enfants et 20 petits-enfants, 
                                        chacun une branche de l’arbre puissant de Maman. Son amour, forgé dans ces longues marches vers les marchés, nous unit tous, et je m’efforce d’honorer son héritage en enseignant à ma famille la résilience qu’elle incarnait.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 pt-6 border-t border-emerald-100">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-emerald-700">
                                    ...
                                    <div>
                                        ...
                                        <p>15 enfants et 20 petits enfants</p>
                                    </div>
                                </div>
                            </div>
                        </div>
