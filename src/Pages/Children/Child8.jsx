                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-emerald-50 rounded-xl p-4 sm:p-6 max-h-96 overflow-y-auto">
                                    <p className="text-gray-700 leading-relaxed text-justify text-sm sm:text-base">
                                        Je suis Julius, le plus jeune de Maman, enveloppé de son amour sans bornes. 
                                        Ses voyages de 5 heures vers Pont-Sondé, seule après la mort de Papa, étaient pour mes 6 enfants et moi. 
                                        <br /><br />
                                        Sa foi et son labeur nous ont donné l’éducation, une chance de nous envoler. 
                                        La douce force de Maman, ses prières à l’aube, vivent dans ma famille. 
                                        Je leur parle d’elle, la femme qui nous a portés vers la grandeur, reposant maintenant dans la paix de Dieu, son amour à jamais notre guide.
                                    </p>
                                </div>
                            </div>
