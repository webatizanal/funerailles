                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-emerald-50 rounded-xl p-4 sm:p-6 max-h-96 overflow-y-auto">
                                    <p className="text-gray-700 leading-relaxed text-justify text-sm sm:text-base">
                                        Je suis Dominique, l’enfant de Maman, modelé par ses vœux tacites. 
                                        Elle marchait 10 kilomètres jusqu’aux marchés de Saint Marc, le dos plié sous des charges, 
                                        pour que nous prospérions. 
                                        <br /><br />
                                        Sa fierté pour mon éducation me réchauffe encore. 
                                        Mes 5 enfants et 5 petits-enfants portent son esprit ses leçons d’amour et de persévérance. 
                                        La vie de Maman était un témoignage de tout donner pour nous, 
                                        et j’enseigne à ma famille à vivre avec le même feu désintéressé qu’elle montrait chaque jour.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 pt-6 border-t border-emerald-100">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-emerald-700">
                                    ...
                                    <div>
                                        ...
                                        <p>Diplomate, Relations Internationales, Loi Internationale</p>
                                    </div>
                                    <div>
                                        <span className="font-semibold">Lieu de résidence :</span>
                                        <p>Saint Marc, Haïti</p>
                                    </div>
                                    <div>
