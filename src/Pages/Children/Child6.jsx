                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-emerald-50 rounded-xl p-4 sm:p-6 max-h-96 overflow-y-auto">
                                    <p className="text-gray-700 leading-relaxed text-justify text-sm sm:text-base">
                                        Je suis Denise, la fille de Maman, grâce à elle, ses marches infinies 36 kilomètres jusqu’à Verrettes étaient pour moi, 
                                        mes 3 enfants et 4 petits-enfants. 
                                        <br /><br />
                                        Elle portait nos rêves dans ses paniers, sa foi dans son cœur, nous élevant seule avec une loyauté qui m’a façonnée. 
                                        L’amour de Maman vit dans mon cœur, dans ma famille, dans chaque leçon que je partage. 
                                        Son héritage est notre force, et je l’honore en vivant comme elle, dévouée et inébranlable.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 pt-6 border-t border-emerald-100">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-emerald-700">
                                    ...
                                    <div>
                                        ...
                                        <p>3 enfants et 4 petits enfants</p>
                                    </div>
                                </div>
                            </div>
                        </div>
