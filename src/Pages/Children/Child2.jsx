                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-emerald-50 rounded-xl p-4 sm:p-6 max-h-96 overflow-y-auto">
                                    <p className="text-gray-700 leading-relaxed text-justify text-sm sm:text-base">
                                        Je suis Elfise, la fille de Maman, façonnée par son courage. Elle parcourait 20 kilomètres jusqu’à Desarmes, chaque pas un serment de nous offrir un avenir. 
                                        Grâce à elle, j’ai appris à me tenir droite, à partager, à aimer farouchement. 
                                        <br /><br />
                                        Mes 8 enfants et 14 petits-enfants sont son héritage, poussant des graines qu’elle a plantées à chaque kilomètre épuisant. 
                                        La foi et la ténacité de Maman vivent en nous, et je raconte à ma famille l’histoire de la femme qui nous a portés à travers la poussière vers un lendemain meilleur.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 pt-6 border-t border-emerald-100">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-emerald-700">
                                    ...
                                    <div>
                                        ...
                                        <p>8 enfants et 14 petits enfants</p>
                                    </div>
                                </div>
                            </div>
                        </div>
